...
//		System.out.println(m.getMemberId());
	...
	public Boolean updateMember(Member m) throws SQLException, ClassNotFoundException, IOException {
		// Declare variables
		Connection conn = null;
		PreparedStatement stmt = null;
		...
		String updateString = "UPDATE `members` SET `name` = ?, `email` = ?, `password` = ?, `favorite_language` = ? WHERE `member_id` = ?;";
